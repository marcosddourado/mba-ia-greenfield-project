...
export class CreateVideos1788745243630 implements MigrationInterface {
  name = 'CreateVideos1788745243630';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "videos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "public_id" character varying(16) NOT NULL, "channel_id" uuid NOT NULL, "title" character varying(255), "original_filename" character varying(255), "content_type" character varying(128), "size_bytes" bigint, "status" "public"."videos_status_enum" NOT NULL DEFAULT 'draft', "storage_key" character varying(512), "thumbnail_key" character varying(512), "duration_seconds" integer, "metadata" jsonb, "upload_id" character varying(255), "processed_at" TIMESTAMP WITH TIME ZONE, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_39a1f0fe7991162aace659078ec" UNIQUE ("public_id"), CONSTRAINT "PK_e4c86c0cf95aff16e9fb8220f6b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
